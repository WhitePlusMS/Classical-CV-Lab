(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,21306,e=>{"use strict";var t=e.i(43476),s=e.i(71645),a=e.i(57688);e.i(33999);var r=e.i(83032),i=e.i(13870),l=e.i(75345),m=e.i(54712),n=e.i(85255),o=e.i(9821),d=e.i(27981),x=e.i(96891),c=e.i(55052),h=e.i(12392);function u(e,t,s,a){let r=2*a+1,i=(0,h.create2DArray)(r,r,0),l=(0,h.create2DArray)(r,r,0),m=e[0]?.length??0,n=e.length;for(let r=-a;r<=a;r++)for(let o=-a;o<=a;o++){let d=t+o,x=s+r,c=r+a,h=o+a;if(d<=0||d>=m-1||x<=0||x>=n-1)continue;let u=e[x][d+1]-e[x][d-1],p=e[x+1][d]-e[x-1][d];i[c][h]=Math.sqrt(u*u+p*p),l[c][h]=Math.atan2(p,u)}return{magnitudes:i,orientations:l}}function p(e,t,s){let a=Array(8).fill(0),r=2*Math.PI/8;for(let i=-s;i<=s;i++)for(let l=-s;l<=s;l++){let m=i+s,n=l+s,o=Math.floor((t[m][n]+Math.PI)/r)%8,d=Math.exp(-(l*l+i*i)/(2*(.5*s)**2));a[o]+=e[m][n]*d}let i=a.reduce((e,t)=>e+t,0);if(i>0)for(let e=0;e<8;e++)a[e]/=i;return a}function g(e,t,s,a,r){let i=[],l=[];for(let m=0;m<4;m++)for(let n=0;n<4;n++){let o=Array(8).fill(0),d=a+(m-1.5)*4,x=s+(n-1.5)*4;for(let i=-1;i<=1;i++)for(let l=-1;l<=1;l++){let c=Math.round(d+i)-(a-8),h=Math.round(x+l)-(s-8);if(c<0||c>=t.length||h<0||h>=(t[0]?.length??0))continue;let u=e[c][h],p=(Math.floor((t[c][h]-r+Math.PI)/(Math.PI/4))%8+8)%8,g=Math.sqrt((m-1.5+i/4)**2+(n-1.5+l/4)**2);o[p]+=u*Math.exp(-g*g/2)}let c=o.reduce((e,t)=>e+t,0);if(c>0)for(let e=0;e<8;e++)o[e]/=c;i.push(...o),l.push(o)}let m=Math.sqrt(i.reduce((e,t)=>e+t*t,0));if(m>0){for(let e=0;e<i.length;e++)i[e]/=m;for(let e=0;e<16;e++)for(let t=0;t<8;t++)l[e][t]/=m}return{descriptor:i,grid:l}}function b(e,t,s,a){let r=[],i=[],l=20*a/4,m=e[0]?.length??0,n=e.length;for(let a=0;a<4;a++)for(let o=0;o<4;o++){let d=t+(o-1.5)*l,x=s+(a-1.5)*l,c=0,h=0,u=0,p=0;for(let t=-2;t<=2;t++)for(let s=-2;s<=2;s++){let a=Math.round(d+s),r=Math.round(x+t);if(a<=0||a>=m-1||r<=0||r>=n-1)continue;let i=e[r][a+1]-e[r][a-1],l=e[r+1][a]-e[r-1][a];c+=i,h+=l,u+=Math.abs(i),p+=Math.abs(l)}r.push(c,h,u,p),i.push([c,h,u,p])}let o=Math.sqrt(r.reduce((e,t)=>e+t*t,0));if(o>0){for(let e=0;e<r.length;e++)r[e]/=o;for(let e=0;e<16;e++)for(let t=0;t<4;t++)i[e][t]/=o}return{descriptor:r,grid:i}}function f(e,t,s,a){let r=2**(1/Math.max(s,1)),i=[];for(let a=0;a<s+2;a++)i.push(function(e,t){let s=e.length,a=e[0]?.length??0;if(0===s||0===a)return e;let r=Math.ceil(2*t),i=2*r+1,l=Array(i),m=0;for(let e=0;e<i;e++){let s=e-r;l[e]=Math.exp(-(s*s)/(2*t*t)),m+=l[e]}for(let e=0;e<i;e++)l[e]/=m;let n=(0,h.create2DArray)(s,a,0);for(let t=0;t<s;t++)for(let s=0;s<a;s++){let m=0;for(let n=0;n<i;n++){let i=s+n-r;i>=0&&i<a&&(m+=e[t][i]*l[n])}n[t][s]=m}let o=(0,h.create2DArray)(s,a,0);for(let e=0;e<s;e++)for(let t=0;t<a;t++){let a=0;for(let m=0;m<i;m++){let i=e+m-r;i>=0&&i<s&&(a+=n[i][t]*l[m])}o[e][t]=a}return o}(e,t*r**a));let l=[];for(let e=0;e<s+1;e++)l.push(function(e,t){let s=e.length,a=e[0]?.length??0,r=(0,h.create2DArray)(s,a,0);for(let i=0;i<s;i++)for(let s=0;s<a;s++)r[i][s]=t[i][s]-e[i][s];return r}(i[e],i[e+1]));let m=new Map,n=[],o=l[0]?.length??e.length,d=l[0]?.[0]?.length??e[0]?.length??64;for(let e=1;e<l.length-1;e++){let s=function(e,t,s,a){let r=t.length,i=t[0]?.length??0,l=[],m=new Map;for(let n=1;n<r-1;n++)for(let r=1;r<i-1;r++){let o=t[n][r];if(.005>Math.abs(o))continue;let d=[],x=[],c=[],h=!0,u=!0;for(let e=-1;e<=1;e++)for(let s=-1;s<=1;s++){let a;if(0===s&&0===e)continue;let i=t[n+e][r+s];o>i?a="greater":o<i?(a="less",h=!1):(a="equal",h=!1,u=!1),i>=o&&(h=!1),i<=o&&(u=!1),d.push({dx:s,dy:e,value:i,relation:a})}if(!h&&!u)continue;for(let t=-1;t<=1;t++)for(let s=-1;s<=1;s++){let a,i=e[n+t][r+s];o>i?a="greater":o<i?(a="less",h=!1):(a="equal",h=!1,u=!1),i>=o&&(h=!1),i<=o&&(u=!1),x.push({dx:s,dy:t,value:i,relation:a})}if(!h&&!u)continue;for(let e=-1;e<=1;e++)for(let t=-1;t<=1;t++){let a,i=s[n+e][r+t];o>i?a="greater":o<i?(a="less",h=!1):(a="equal",h=!1,u=!1),i>=o&&(h=!1),i<=o&&(u=!1),c.push({dx:t,dy:e,value:i,relation:a})}if(!h&&!u)continue;let p=h?"max":"min",g=(e,t,s)=>{let a=[];for(let r=-1;r<=1;r++){let i=[];for(let a=-1;a<=1;a++)i.push(e[s+r][t+a]);a.push(i)}return a},b={prevDogPatch:g(e,r,n),currentDogPatch:g(t,r,n),nextDogPatch:g(s,r,n),currentValue:o,prevComparisons:x,sameComparisons:d,nextComparisons:c,isExtremum:!0,extremumType:p},f=n*i+r;m.set(f,b),l.push({x:r,y:n,octave:0,scale:a,orientation:0,magnitude:Math.abs(o),siftDescriptor:[],surfDescriptor:[]})}return{keypoints:l,comparisons:m}}(l[e-1],l[e],l[e+1],e),a=t*r**e;for(let e of s.keypoints)e.scale=a;let i=e*o*d;for(let[e,t]of s.comparisons)m.set(i+e,t);n.push(...s.keypoints)}let x=[];for(let t of n){let{magnitudes:s,orientations:a}=u(e,t.x,t.y,8),r=function(e){let t=2*Math.PI/8,s=0;for(let t=1;t<8;t++)e[t]>e[s]&&(s=t);return s*t-Math.PI}(p(s,a,8)),{descriptor:i}=g(s,a,t.x,t.y,r),{descriptor:l}=b(e,t.x,t.y,Math.max(t.scale,1));x.push({...t,orientation:r,magnitude:t.magnitude,siftDescriptor:i,surfDescriptor:l})}x.sort((e,t)=>t.magnitude-e.magnitude);let c=x.slice(0,20),f={gaussianValues:i[0],dogValues:l[0],currentKeypoint:null,gradientMagnitudes:null,gradientOrientations:null,orientationHistogram:null,siftDescriptorGrid:null,surfDescriptorGrid:null,matches:null,neighborComparisons:null};if(c.length>0){let s=Math.min(a,c.length-1),n=c[s],{magnitudes:x,orientations:h}=u(e,n.x,n.y,8),j=p(x,h,8),{grid:y}=g(x,h,n.x,n.y,n.orientation),{grid:N}=b(e,n.x,n.y,Math.max(n.scale,1)),v=Math.round(Math.log(n.scale/t)/Math.log(r))*o*d+n.y*d+n.x,w=m.get(v)??null;f={gaussianValues:i[0],dogValues:l[0],currentKeypoint:n,gradientMagnitudes:x,gradientOrientations:h,orientationHistogram:j,siftDescriptorGrid:y,surfDescriptorGrid:N,matches:[],neighborComparisons:w}}return{keypoints:c,gaussianScales:i,dogScales:l,stepData:f,allSiftDescriptors:c.map(e=>e.siftDescriptor),allSurfDescriptors:c.map(e=>e.surfDescriptor)}}var j=e.i(34928),y=e.i(43082),N=e.i(50192),v=e.i(35126);let w=[{key:"overview",label:"概览",summary:"SIFT 四步流程"},{key:"scale-space",label:"尺度空间",summary:"不同σ看结构"},{key:"dog-detection",label:"DoG检测",summary:"26邻域极值"},{key:"orientation",label:"方向分配",summary:"梯度投票→主方向"},{key:"descriptor",label:"描述子",summary:"128维特征向量"},{key:"matching",label:"特征匹配",summary:"跨图比值检验"}],S=[{value:"rectangle",label:"矩形"},{value:"circle",label:"圆形"},{value:"lenaOriginal",label:"Lena 灰度图"}],F=[{value:"auto",label:"自动匹配"},{value:"rectangle",label:"矩形参考图"},{value:"circle",label:"圆形参考图"},{value:"lenaRotated",label:"旋转缩放(Lena)"}],C=(0,n.buildInlineMathML)("<mrow><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>=</mo><mi>G</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>*</mo><mi>I</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo></mrow>"),D=(0,n.buildInlineMathML)("<mrow><mi>G</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>=</mo><mfrac><mn>1</mn><mrow><mn>2</mn><mi>π</mi><msup><mi>σ</mi><mn>2</mn></msup></mrow></mfrac><msup><mi>e</mi><mrow><mo>-</mo><mfrac><mrow><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><msup><mi>y</mi><mn>2</mn></msup></mrow><mrow><mn>2</mn><msup><mi>σ</mi><mn>2</mn></msup></mrow></mfrac></mrow></msup></mrow>"),I=(0,n.buildInlineMathML)("<mrow><mi>D</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>=</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>k</mi><mi>σ</mi><mo>)</mo><mo>-</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo></mrow>"),M=(0,n.buildInlineMathML)("<mrow><mi>m</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>=</mo><msqrt><msup><mrow><mo>(</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>+</mo><mn>1</mn><mo>,</mo><mi>y</mi><mo>)</mo><mo>-</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>-</mo><mn>1</mn><mo>,</mo><mi>y</mi><mo>)</mo><mo>)</mo></mrow><mn>2</mn></msup><mo>+</mo><msup><mrow><mo>(</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>+</mo><mn>1</mn><mo>)</mo><mo>-</mo><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>-</mo><mn>1</mn><mo>)</mo><mo>)</mo></mrow><mn>2</mn></msup></msqrt></mrow>"),T=(0,n.buildInlineMathML)("<mrow><mi>θ</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>=</mo><mi>atan2</mi><mo>(</mo><msub><mi>L</mi><mi>y</mi></msub><mo>,</mo><msub><mi>L</mi><mi>x</mi></msub><mo>)</mo></mrow>"),k=(0,n.buildInlineMathML)("<mrow><mrow><mo>[</mo><mtable><mtr><mtd><msup><mi>x</mi><mo>′</mo></msup></mtd></mtr><mtr><mtd><msup><mi>y</mi><mo>′</mo></msup></mtd></mtr></mtable><mo>]</mo></mrow><mo>=</mo><mrow><mo>[</mo><mtable><mtr><mtd><mi>cos</mi><mi>θ</mi></mtd><mtd><mo>-</mo><mi>sin</mi><mi>θ</mi></mtd></mtr><mtr><mtd><mi>sin</mi><mi>θ</mi></mtd><mtd><mi>cos</mi><mi>θ</mi></mtd></mtr></mtable><mo>]</mo></mrow><mrow><mo>[</mo><mtable><mtr><mtd><mi>x</mi></mtd></mtr><mtr><mtd><mi>y</mi></mtd></mtr></mtable><mo>]</mo></mrow></mrow>"),G=(0,n.buildInlineMathML)("<mrow><msub><mi>l</mi><mi>j</mi></msub><mo>=</mo><mfrac><msub><mi>w</mi><mi>j</mi></msub><mrow><msqrt><munderover><mo>∑</mo><mrow><mi>i</mi><mo>=</mo><mn>1</mn></mrow><mn>128</mn></munderover><msup><msub><mi>w</mi><mi>i</mi></msub><mn>2</mn></msup></msqrt></mrow></mfrac><mo>,</mo><mi>j</mi><mo>=</mo><mn>1</mn><mo>,</mo><mn>2</mn><mo>,</mo><mo>⋯</mo><mo>,</mo><mn>128</mn></mrow>"),R=(0,n.buildInlineMathML)("<mrow><mi>H</mi><mo>(</mo><mi>X</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>=</mo><mrow><mo>[</mo><mtable><mtr><mtd><msub><mi>L</mi><mrow><mi>x</mi><mi>x</mi></mrow></msub><mo>(</mo><mi>X</mi><mo>,</mo><mi>σ</mi><mo>)</mo></mtd><mtd><msub><mi>L</mi><mrow><mi>x</mi><mi>y</mi></mrow></msub><mo>(</mo><mi>X</mi><mo>,</mo><mi>σ</mi><mo>)</mo></mtd></mtr><mtr><mtd><msub><mi>L</mi><mrow><mi>x</mi><mi>y</mi></mrow></msub><mo>(</mo><mi>X</mi><mo>,</mo><mi>σ</mi><mo>)</mo></mtd><mtd><msub><mi>L</mi><mrow><mi>y</mi><mi>y</mi></mrow></msub><mo>(</mo><mi>X</mi><mo>,</mo><mi>σ</mi><mo>)</mo></mtd></mtr></mtable><mo>]</mo></mrow></mrow>"),L=(0,n.buildInlineMathML)("<mrow><mi>det</mi><mo>(</mo><msub><mi>H</mi><mrow><mi>approx</mi></mrow></msub><mo>)</mo><mo>=</mo><msub><mi>D</mi><mrow><mi>x</mi><mi>x</mi></mrow></msub><msub><mi>D</mi><mrow><mi>y</mi><mi>y</mi></mrow></msub><mo>-</mo><mo>(</mo><mi>w</mi><msub><mi>D</mi><mrow><mi>x</mi><mi>y</mi></mrow></msub><msup><mo>)</mo><mn>2</mn></msup></mrow>"),U=(0,n.buildInlineMathML)("<mrow><mi>II</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>=</mo><munderover><mo>∑</mo><mrow><msup><mi>x</mi><mo>′</mo></msup><mo>≤</mo><mi>x</mi></mrow><mrow></mrow></munderover><munderover><mo>∑</mo><mrow><msup><mi>y</mi><mo>′</mo></msup><mo>≤</mo><mi>y</mi></mrow><mrow></mrow></munderover><mi>I</mi><mo>(</mo><msup><mi>x</mi><mo>′</mo></msup><mo>,</mo><msup><mi>y</mi><mo>′</mo></msup><mo>)</mo></mrow>"),P=(0,n.buildInlineMathML)("<mrow><mi>D</mi><mo>(</mo><msub><mi>X</mi><mi>i</mi></msub><mo>,</mo><msub><mi>X</mi><mi>j</mi></msub><mo>)</mo><mo>=</mo><msqrt><munderover><mo>∑</mo><mrow><mi>k</mi><mo>=</mo><mn>0</mn></mrow><mi>n</mi></munderover><msup><mrow><mo>(</mo><msub><mi>X</mi><mrow><mi>i</mi><mi>k</mi></mrow></msub><mo>-</mo><msub><mi>X</mi><mrow><mi>j</mi><mi>k</mi></mrow></msub><mo>)</mo></mrow><mn>2</mn></msup></msqrt></mrow>"),K=(0,n.buildInlineMathML)("<mrow><mtable><mtr><mtd><mi>D</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mtext> 为局部极值 </mtext><mo>⟺</mo></mtd></mtr><mtr><mtd><mtext>同层 8 邻域: </mtext><mi>D</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>&gt;</mo><mi>D</mi><mo>(</mo><mi>x</mi><mo>+</mo><mi>d</mi><mi>x</mi><mo>,</mo><mi>y</mi><mo>+</mo><mi>d</mi><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>,</mo><mtext> </mtext><mi>d</mi><mi>x</mi><mo>,</mo><mi>d</mi><mi>y</mi><mo>∈</mo><mo>{</mo><mo>-</mo><mn>1</mn><mo>,</mo><mn>0</mn><mo>,</mo><mn>1</mn><mo>}</mo><mo>,</mo><mtext> </mtext><mo>(</mo><mi>d</mi><mi>x</mi><mo>,</mo><mi>d</mi><mi>y</mi><mo>)</mo><mo>≠</mo><mo>(</mo><mn>0</mn><mo>,</mo><mn>0</mn><mo>)</mo></mtd></mtr><mtr><mtd><mtext>上层 9 邻域: </mtext><mi>D</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>&gt;</mo><mi>D</mi><mo>(</mo><mi>x</mi><mo>+</mo><mi>d</mi><mi>x</mi><mo>,</mo><mi>y</mi><mo>+</mo><mi>d</mi><mi>y</mi><mo>,</mo><mi>k</mi><mi>σ</mi><mo>)</mo><mo>,</mo><mtext> </mtext><mi>d</mi><mi>x</mi><mo>,</mo><mi>d</mi><mi>y</mi><mo>∈</mo><mo>{</mo><mo>-</mo><mn>1</mn><mo>,</mo><mn>0</mn><mo>,</mo><mn>1</mn><mo>}</mo></mtd></mtr><mtr><mtd><mtext>下层 9 邻域: </mtext><mi>D</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>&gt;</mo><mi>D</mi><mo>(</mo><mi>x</mi><mo>+</mo><mi>d</mi><mi>x</mi><mo>,</mo><mi>y</mi><mo>+</mo><mi>d</mi><mi>y</mi><mo>,</mo><mi>σ</mi><mo>/</mo><mi>k</mi><mo>)</mo><mo>,</mo><mtext> </mtext><mi>d</mi><mi>x</mi><mo>,</mo><mi>d</mi><mi>y</mi><mo>∈</mo><mo>{</mo><mo>-</mo><mn>1</mn><mo>,</mo><mn>0</mn><mo>,</mo><mn>1</mn><mo>}</mo></mtd></mtr><mtr><mtd><mtext>（或全部 </mtext><mo>&lt;</mo><mtext>，为局部极小值）</mtext></mtd></mtr></mtable></mrow>"),H=(0,n.buildInlineMathML)("<mrow><mi>L</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>=</mo><mi>G</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>,</mo><mi>σ</mi><mo>)</mo><mo>*</mo><mi>I</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>=</mo><mrow><mo>[</mo><mfrac><mn>1</mn><mrow><mn>2</mn><mi>π</mi><msup><mi>σ</mi><mn>2</mn></msup></mrow></mfrac><msup><mi>e</mi><mrow><mo>-</mo><mfrac><mrow><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><msup><mi>y</mi><mn>2</mn></msup></mrow><mrow><mn>2</mn><msup><mi>σ</mi><mn>2</mn></msup></mrow></mfrac></mrow></msup><mo>]</mo></mrow><mo>*</mo><mi>I</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo></mrow>"),z=(0,n.buildInlineMathML)("<mrow><msub><mi>d</mi><mi>x</mi></msub><mo>=</mo><munder><mo>∑</mo><mrow></mrow></munder><mi>I</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>·</mo><msub><mi>W</mi><mi>x</mi></msub><mo>,</mo><mtext> </mtext><msub><mi>d</mi><mi>y</mi></msub><mo>=</mo><munder><mo>∑</mo><mrow></mrow></munder><mi>I</mi><mo>(</mo><mi>x</mi><mo>,</mo><mi>y</mi><mo>)</mo><mo>·</mo><msub><mi>W</mi><mi>y</mi></msub></mrow>");function q({hist:e,highlightBin:s}){let a=Math.max(...e,.01);return(0,t.jsx)("div",{className:"grid grid-cols-8 gap-1",children:e.map((e,r)=>(0,t.jsxs)("div",{className:"flex flex-col items-center",children:[(0,t.jsx)("div",{className:"flex h-20 w-full items-end justify-center",children:(0,t.jsx)("div",{className:"w-full rounded-t "+(s===r?"bg-amber-500":"bg-amber-400"),style:{height:Math.max(e/a*100,5)+"%"}})}),(0,t.jsxs)("span",{className:"mt-1 text-[9px] text-slate-500",children:[45*r,"°"]})]},r))})}function A({grid:e,label:s}){if(0===e.length)return null;let a=Math.max(...e.flat(),.01);return(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsx)("div",{className:"text-[10px] font-medium text-slate-500",children:s}),(0,t.jsx)("div",{className:"grid grid-cols-4 gap-1",children:e.map((e,s)=>(0,t.jsxs)("div",{className:"rounded border border-slate-200 bg-white p-1",children:[(0,t.jsxs)("div",{className:"text-[8px] text-slate-400",children:["R",s]}),(0,t.jsx)("div",{className:"mt-0.5 grid grid-cols-1 gap-0.5",children:e.map((e,s)=>(0,t.jsxs)("div",{className:"flex items-center gap-0.5",children:[(0,t.jsx)("div",{className:"h-1.5 flex-1 rounded",style:{backgroundColor:"rgba(251, 146, 60, "+Math.max(e/a,.05)+")"}}),(0,t.jsx)("span",{className:"w-5 text-right text-[7px] font-mono text-slate-500",children:e.toFixed(1)})]},s))})]},s))})]})}function O({data:e}){let s=(e,s,a,r)=>{let i=a.filter(e=>"greater"===e.relation).length,l=Math.max(...e.flat().map(Math.abs),.001);return(0,t.jsxs)("div",{className:"flex flex-col items-center",children:[(0,t.jsx)("div",{className:"mb-1 text-[10px] font-semibold text-slate-500",children:s}),(0,t.jsx)("div",{className:"grid grid-cols-3 gap-0.5",children:e.map((e,s)=>e.map((e,a)=>{let i=1===s&&1===a,m=Math.min(Math.abs(e)/l,1),n=e>0?`rgba(16,185,129,${.08+.55*m})`:e<0?`rgba(239,68,68,${.08+.55*m})`:"white";return(0,t.jsxs)("div",{className:"flex h-7 w-14 items-center justify-center text-[10px] font-mono font-semibold",style:{backgroundColor:n,border:r&&i?"2px solid rgb(239,68,68)":"1px solid rgb(226,232,240)",borderRadius:r&&i?"3px":"0"},children:[e>0?"+":"",e.toFixed(2)]},`${s}-${a}`)}))}),(0,t.jsxs)("div",{className:"mt-1 text-[10px] text-slate-500",children:[i,"/",a.length," 当前值更大"]})]})};return(0,t.jsxs)("div",{className:"space-y-3",children:[(0,t.jsxs)("div",{className:"flex flex-wrap justify-center gap-3",children:[s(e.prevDogPatch,"下层 DoG (σ/k)",e.prevComparisons,!1),s(e.currentDogPatch,"当前层 DoG (σ)",e.sameComparisons,!0),s(e.nextDogPatch,"上层 DoG (kσ)",e.nextComparisons,!1)]}),(0,t.jsx)("div",{className:"rounded-xl border px-4 py-2 text-center text-xs font-semibold "+(e.isExtremum?"border-emerald-200 bg-emerald-50 text-emerald-800":"border-red-200 bg-red-50 text-red-700"),children:e.isExtremum?`✓ 局部${"max"===e.extremumType?"极大":"极小"}值 — 全部 26 邻域比较通过，当前点为候选关键点`:"✗ 非极值 — 未通过 26 邻域比较，当前点被排除"})]})}function V({activeStage:e,onStageChange:s,stageIndex:a}){return(0,t.jsx)("div",{className:"space-y-1.5",children:w.map((r,i)=>{let l=r.key===e,m=i<a;return(0,t.jsxs)("button",{type:"button",onClick:()=>s(r.key),className:"w-full rounded-xl border px-3 py-2 text-left transition "+(l?"border-amber-300 bg-amber-50 text-amber-800":m?"border-slate-200 bg-white text-slate-700":"border-slate-200 bg-slate-50 text-slate-500"),children:[(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("span",{className:"flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-[11px] font-semibold "+(l?"bg-amber-600 text-white":m?"bg-slate-700 text-white":"border border-slate-300 bg-white text-slate-500"),children:m?"✓":i+1}),(0,t.jsx)("span",{className:"text-sm font-semibold",children:r.label})]}),(0,t.jsx)("div",{className:"mt-1 pl-8 text-xs leading-5",children:r.summary})]},r.key)})})}function $({activeTab:e,onChange:s}){return(0,t.jsxs)("div",{className:"flex items-center",children:[(0,t.jsx)("div",{className:"flex rounded-xl border border-slate-200 bg-slate-100 p-0.5",children:[{key:"sift",label:"SIFT 视角"},{key:"surf",label:"SURF 视角"},{key:"compare",label:"对比表"}].map(a=>(0,t.jsx)("button",{type:"button",onClick:()=>s(a.key),className:"rounded-lg px-3 py-1.5 text-xs font-semibold transition "+(e===a.key?"bg-white text-slate-800 shadow-sm":"text-slate-500 hover:text-slate-700"),children:a.label},a.key))}),"sift"===e&&(0,t.jsx)("span",{className:"ml-3 text-[11px] text-amber-600",children:"💡 SURF 用积分图加速 → 点击 SURF 标签查看"})]})}function B(){return(0,t.jsxs)(x.TeachingCard,{children:[(0,t.jsx)("div",{className:"text-sm font-semibold text-slate-800",children:"SIFT vs SURF 全流程对比"}),(0,t.jsx)("div",{className:"mt-3 w-full overflow-x-auto",children:(0,t.jsxs)("table",{className:"w-full border-collapse text-[11px]",children:[(0,t.jsx)("thead",{children:(0,t.jsxs)("tr",{className:"border-b border-slate-300",children:[(0,t.jsx)("th",{className:"px-3 py-2 text-left font-semibold text-slate-700",children:"特性"}),(0,t.jsx)("th",{className:"px-3 py-2 text-left font-semibold text-slate-700",children:"SIFT"}),(0,t.jsx)("th",{className:"px-3 py-2 text-left font-semibold text-slate-700",children:"SURF"})]})}),(0,t.jsx)("tbody",{children:[{feature:"尺度空间",sift:"标准：octave 降采样改变图像大小<br/>本页实现：固定图像尺寸、改变 σ（教学简化）",surf:"固定图像大小，不同尺度 box filter"},{feature:"特征点检测",sift:"DoG 非极大抑制 + 26 邻域",surf:"Hessian 行列式 + 非极大抑制"},{feature:"方向",sift:"正方形区域梯度直方图（36柱）",surf:"圆形区域 Haar 小波，扇形滑动"},{feature:"描述子邻域",sift:"16x16",surf:"20s x 20s"},{feature:"描述子维数",sift:"128",surf:"64"},{feature:"描述方法",sift:"8方向梯度直方图",surf:"&Sigma;dx, &Sigma;|dx|, &Sigma;dy, &Sigma;|dy|"},{feature:"不变性",sift:"尺度+旋转+光照",surf:"尺度+旋转+光照"},{feature:"速度",sift:"较慢",surf:"较快（积分图加速）"}].map((e,s)=>(0,t.jsxs)("tr",{className:"border-b border-slate-200",children:[(0,t.jsx)("td",{className:"px-3 py-1.5 font-medium text-slate-600",children:e.feature}),(0,t.jsx)("td",{className:"px-3 py-1.5 text-slate-700",dangerouslySetInnerHTML:{__html:e.sift}}),(0,t.jsx)("td",{className:"px-3 py-1.5 text-slate-700",dangerouslySetInnerHTML:{__html:e.surf}})]},s))})]})})]})}let E=`// 以下代码截取自 src/lib/algorithms/siftSurf.ts，展示核心实现
/**
