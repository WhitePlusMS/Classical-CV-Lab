...
const learningChapters: LearningChapter[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        source: '',
        concepts: [
          placeholder('成像模型与内外参数', 'Camera Model & Parameters', icons.camera, 'from-blue-500 to-indigo-600', 'bg-blue-50', 'text-blue-600'),
          placeholder('标定板与角点检测', 'Calibration Pattern & Corners', icons.feature, 'from-violet-500 to-purple-600', 'bg-violet-50', 'text-violet-600'),
          placeholder('张正友标定与参数求解', 'Zhang Calibration & Estimation', icons.camera, 'from-purple-500 to-fuchsia-600', 'bg-purple-50', 'text-purple-600'),
        ],
      },
      {
        eyebrow: 'Part 3',
    ...
    modules: [
      {
        ...
        source: '',
        concepts: [
          placeholder('阈值分割与自动阈值', 'Threshold & Auto Threshold', icons.threshold, 'from-purple-500 to-violet-600', 'bg-purple-50', 'text-purple-600'),
          placeholder('帧差法与运动检测', 'Frame Difference & Motion', icons.target, 'from-violet-500 to-indigo-600', 'bg-violet-50', 'text-violet-600'),
          placeholder('背景建模与背景减除', 'Background Modeling & Subtraction', icons.target, 'from-indigo-500 to-slate-600', 'bg-indigo-50', 'text-indigo-600'),
        ],
      },
      {
        eyebrow: 'Part 2',
        ...
        source: '',
        concepts: [
          placeholder('特征点检测与匹配流程', 'Keypoint Matching Pipeline', icons.feature, 'from-sky-500 to-blue-600', 'bg-sky-50', 'text-sky-600'),
          placeholder('SIFT / SURF 尺度特征', 'SIFT / SURF Scale Features', icons.feature, 'from-blue-500 to-indigo-600', 'bg-blue-50', 'text-blue-600'),
          placeholder('ORB / BRIEF / BRISK 二进制特征', 'Binary Feature Descriptors', icons.feature, 'from-violet-500 to-purple-600', 'bg-violet-50', 'text-violet-600'),
        ],
      },
      {
        eyebrow: 'Part 3',
        ...
        source: '',
        concepts: [
          placeholder('颜色空间与颜色直方图', 'Color Space & Histogram', icons.histogram, 'from-yellow-500 to-amber-600', 'bg-yellow-50', 'text-yellow-700'),
          placeholder('LBP 与 Gabor 纹理特征', 'LBP & Gabor Texture', icons.feature, 'from-emerald-500 to-green-600', 'bg-emerald-50', 'text-emerald-600'),
          placeholder('直方图匹配与模板匹配', 'Histogram & Template Matching', icons.convolution, 'from-cyan-500 to-blue-600', 'bg-cyan-50', 'text-cyan-600'),
        ],
      },
      {
        eyebrow: 'Part 4',
        ...
        concepts: [
          ...
          placeholder('Haar / LBP 特征向量', 'Haar / LBP Feature Vector', icons.feature, 'from-orange-500 to-amber-600', 'bg-orange-50', 'text-orange-600'),
          placeholder('分类器与检测流程', 'Classifier & Detection Pipeline', icons.target, 'from-amber-500 to-yellow-600', 'bg-amber-50', 'text-amber-700'),
        ],
      },
    ],
  },
